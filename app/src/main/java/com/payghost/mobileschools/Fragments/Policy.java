...
public class Policy extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=   inflater.inflate(R.layout.policy_fragment_layout, container, false);
    ...
    public void fetch()
    {
                        ...
                        if(!response.equalsIgnoreCase("nodata")) {
                            try {
                                ...
                                for (int i = 0; i < result.length(); i++) {
                                    ...
                                    arrList.add(new RetrieveService(title,message,"",link,""));
                ...
                })
        {
            ...
            protected Map<String, String> getParams()
            {
                ...
                parameters.put("identifier","policy");
                parameters.put("link","");
