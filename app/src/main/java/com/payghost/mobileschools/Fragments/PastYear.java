...
public class PastYear extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=   inflater.inflate(R.layout.past_year_fragment_layout, container, false);
    ...
    public void fetch()
    {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Config.URL_GET_ALL_PAST,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new RecyclerviewAdapter(getActivity().getApplicationContext(),arrList,getFragmentManager());
                ...
                })
        {
            ...
            protected Map<String, String> getParams()
            {
                ...
                parameters.put("module",Config.TAG_SUBJECT);
